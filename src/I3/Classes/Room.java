...
/**
 * Represents a room in the hotel, including its facilities and class/fare.
 *
 * @author Faysal Ahmed
 */
public class Room {
    ...
    public void setRoom_no(String room_no) {
        this.room_no = (room_no == null) ? "" : room_no.trim();
    }
    ...
    public void setBed_number(int bed_number) {
        this.bed_number = Math.max(0, bed_number);
    }
    ...
    public String toString() {
        // Useful for UI lists/comboboxes
        return room_no;
    }
}
